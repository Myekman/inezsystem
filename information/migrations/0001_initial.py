    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_active', models.BooleanField(default=False)),
                ('day_created', models.DateTimeField(auto_now_add=True)),
                ('car_type_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='information.cartype')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='information.unit')),
            ],
        ),
        migrations.CreateModel(
            name='Scaffold',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scaffold_number', models.IntegerField()),
                ('scaffold_location', models.CharField(max_length=200)),
                ('scaffold_for', models.CharField(max_length=200)),
                ('scaffold_marking', models.CharField(blank=True, max_length=200)),
                ('scaffold_po', models.CharField(blank=True, max_length=200)),
                ('scaffold_cubic', models.IntegerField(blank=True, default=0, validators=[information.models.validate_positive_or_zero])),
                ('scaffold_stair', models.IntegerField(blank=True, default=0, validators=[information.models.validate_positive_or_zero])),
